...
class GalleryLessonRepository extends AbstractFilteredRepository<int, Lesson, GalleryLessonFilter> {
  static const _entitiesName = 'gallery/lessons';
  final _client = GetIt.instance.get<ApiClient>();

  @override
  Future<ListLoadResult<Lesson>> loadWithFilter(GalleryLessonFilter filter, String? pageToken) {
    return _client
